    ...
    <template v-if="material">
      <header class="page-header">
        ...
        <div>
          ...
          <el-button type="primary" @click="router.push({ path: '/inspections/new', query: { materialId: material.id } })">来料报检</el-button>
      ...
      <section class="panel">
        ...
        <el-empty v-if="material.batches.length === 0" description="该材料还没有批次">
          <el-button type="primary" @click="router.push({ path: '/inspections/new', query: { materialId: material.id } })">登记第一批来料质检</el-button>
        </el-empty>
      </section>
    </template>
  </div>
