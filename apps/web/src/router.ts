...
const router = createRouter({
  ...
  routes: [
    ...
    { path: "/inspections", component: () => import("@/pages/InspectionsPage.vue") },
    { path: "/inspections/new", component: () => import("@/pages/InspectionFormPage.vue") },
    { path: "/inspections/:id", component: () => import("@/pages/InspectionDetailPage.vue") },
